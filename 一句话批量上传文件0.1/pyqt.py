...
setup(version = "0.1",description = "QQ:1043733492",name = "FTP",zipfile=None,windows=[{"script": "wwwtest.py", "icon_resources": [(1, "App.ico")]}],
      options={"py2exe":{"dll_excludes":["MSVCP90.dll"],"includes":["sip"]}},includes = ["yijuhua.py"])
