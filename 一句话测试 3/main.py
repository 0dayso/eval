        ...
        try:
            while True:
                ...
                if yijuhua_cs(ASP_PHP,self.URL[0],self.URL[1]): #ASP还是PHP  ,URL地址 ，密码
                    ...
                    data=self.URL[0]+"|"+self.URL[1]+"|"+yijuhua_win_linux(self.URL[0],self.URL[1])+"|"+h.www_data(qqwry.url_www(self.URL[0]))
                    self.TXT_file2("OK.txt",data)
                    #print url
                    print "OK-----",data
                    self.OK+=1
                    time.sleep(2)
